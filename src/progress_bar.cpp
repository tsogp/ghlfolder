...
progress_bar<MIN_WIDTH, MAX_WIDTH>::progress_bar(int width) : width_(std::clamp(width, MIN_WIDTH, MAX_WIDTH)) {}
...
template <int MIN_WIDTH, int MAX_WIDTH>
void progress_bar<MIN_WIDTH, MAX_WIDTH>::resize(int new_width) {
    is_initiated = false;
